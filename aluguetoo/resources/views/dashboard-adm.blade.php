    ...
    <div class="row">
        <nav class="col-md-3 col-lg-2 d-md-block sidebar collapse p-3">
            ...
            <ul class="nav flex-column gap-2">
                <li class="nav-item">
                    <a href="{{ route('dashboard.adm') }}" class="nav-link active">Dashboard</a>
                </li>
                <li class="nav-item">
                    <a href="#" class="nav-link">Usuários</a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('relatorio.equipamentos') }}" class="nav-link">Relatórios</a>
                </li>
            </ul>
